...
![doc/img01](./doc/main1.JPG)

## 검증하기 (정보 확인)

![doc/img01](./doc/msin3.JPG)
...
### 다수의 신고 -> 신고 당 다수의 탐색 구간<br/>

>불법 저작물의 경우, 같은 인터넷 사업자와 국가에서는 같은 양식과 키워드, 언어로 유통되기 때문에, 이러한  특성을 활용하여 정보거래를 통해 얻은 정보를 바탕으로 지속적으로 웹 크롤링<br/>

>각 신고는 자원의 공유가 필요하지 않으므로, 멀티 프로세스를 통해 탐색하고, 신고가 발생시키는 다수의 하이퍼링크는 멀티 쓰레드를 통해 네트워크 I/O 로 인한 유휴시간 동안 GIL의 사용권한을 다른 쓰레드에게 양도 
...
2건의 신고로 크롤러가 탐색한 불법 저작물
![crawling](./doc/evi.PNG)
