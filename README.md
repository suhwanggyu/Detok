...
> 주의
core/decentralized/secrets.json 의 계정은 Ropsten네트워크 이용한 빌드시 Ethereum을 보유하기 위해 몇 일에 걸쳐서 faucet 신청을 해야하기 때문에 체험을 위해 공유되는 계정입니다.<br />  해당 계정을 복원한 메타마스크는 메인네트워크에서 실제 거래를 위해서는 "절대" 사용을 하지 않아야 합니다.
